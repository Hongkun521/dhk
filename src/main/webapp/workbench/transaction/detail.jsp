<%@ page import="com.dhk.crm.settings.domain.DicValue" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.dhk.crm.workbench.domain.Tran" %>
    ...
    function changeStage(stage,i){
        ...
        $.ajax({
            ...
            success:function (data) {
                 ...
                 */
                if(data.success){
                    //改变阶段成功后需要在详细信息页后刷新  刷新阶段，可能性、修改人、修改时间
